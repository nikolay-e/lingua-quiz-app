...
export default [
  ...
  // 2. Base JS Configuration
  {
    ...
    rules: {
      ...
      'no-underscore-dangle': ['warn', { allow: ['__TESTCONTAINER__', '__SERVER__', '_authCheckInterval'] }],
  ...
  // 5. Test Files
  {
    ...
    rules: {
      ...
      'jest/expect-expect': ['warn', { assertFunctionNames: ['expect', 'request.*.expect', '*.expect'] }],
