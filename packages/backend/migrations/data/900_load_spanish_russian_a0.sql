...
DECLARE
  ...
  v_word_list_name CONSTANT VARCHAR := 'Spanish Russian A0';
  v_word_pair_count INTEGER := 0;
  v_json_content TEXT;
  v_json_data JSONB;
  v_word_pair JSONB;
BEGIN
  RAISE NOTICE 'Loading Spanish Russian A0 vocabulary data...';
  ...
  RAISE NOTICE 'JSON file: migrations/data/vocabulary/spanish-russian-a0.json';

  RAISE NOTICE 'Spanish Russian A0 vocabulary loading completed';
END $$;
