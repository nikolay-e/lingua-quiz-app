...
-- Load English Russian B1 vocabulary from JSON data file
DO $$
DECLARE
...
BEGIN
  ...
  RAISE NOTICE 'Loading English Russian B1 vocabulary data...';
  ...
  RAISE NOTICE 'JSON file: migrations/data/vocabulary/english-russian-b1.json';
  ...
  RAISE NOTICE 'English Russian B1 vocabulary loading completed';
