...
class MigrationValidator:
    ...
    def __init__(
        ...
        self.normalizers = {
            lang: get_normalizer(lang) for lang in supported_languages
        }
    ...
    def _validate_cross_language_consistency(self, result: ValidationResult) -> List[ValidationIssue]:
        """
...
def main():
    ...
    parser.add_argument(
        ...
        help='Show brief report (less detailed)'
    )
    parser.add_argument(
